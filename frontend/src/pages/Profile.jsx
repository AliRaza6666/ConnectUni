...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen" style={{backgroundColor: '#FFFFFF'}}>
        ...
        <div className="flex gap-8 md:gap-12">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-4">
              <h2 className="text-xl md:text-2xl font-light" style={{color: '#262626'}}>
            ...
            <div className="flex gap-6 mb-4">
              <div>
                <span className="font-semibold" style={{color: '#262626'}}>{posts.length}</span>
                <span className="ml-1" style={{color: '#262626'}}>posts</span>
              </div>
              <div>
                <span className="font-semibold" style={{color: '#262626'}}>{formatNumber(followers)}</span>
                <span className="ml-1" style={{color: '#262626'}}>followers</span>
              </div>
              <div>
                <span className="font-semibold" style={{color: '#262626'}}>{formatNumber(following)}</span>
                <span className="ml-1" style={{color: '#262626'}}>following</span>
              </div>
            </div>

            {/* Full Name */}
            <div className="mb-2">
              <span className="font-semibold text-base" style={{color: '#262626'}}>{capitalizeName(userFullName)}</span>
            </div>
      ...
      {/* ================= CONTENT TABS ================= */}
      <div className="max-w-4xl mx-auto px-4 border-t" style={{borderColor: '#DBDBDB'}}>
        <div className="flex justify-center gap-12">
          <button className="py-4 border-t-2" style={{borderColor: '#262626'}}>
      ...
      <div className="max-w-4xl mx-auto pb-6">
        {posts.length === 0 ? (
          <div className="text-center py-12 px-4">
            <p className="text-lg" style={{color: '#8E8E8E'}}>No posts yet. Share your first post!</p>
          </div>
        ) : (
          ...
          >
            ...
            {selectedPostIndex > 0 && (
              <button
                ...
                className="absolute left-4 top-1/2 transform -translate-y-1/2 p-3 rounded-full hover:bg-gray-800 transition-colors z-10"
                style={{backgroundColor: 'rgba(0, 0, 0, 0.5)'}}
                aria-label="Previous"
              >
            ...
            {selectedPostIndex < posts.length - 1 && (
              <button
                ...
                className="absolute right-4 top-1/2 transform -translate-y-1/2 p-3 rounded-full hover:bg-gray-800 transition-colors z-10"
                style={{backgroundColor: 'rgba(0, 0, 0, 0.5)'}}
                aria-label="Next"
              >
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-semibold" style={{color: '#262626'}}>Edit Profile</h2>
              <button
                onClick={() => setIsEditModalOpen(false)}
                className="p-1 rounded-full hover:bg-gray-100 transition-colors"
                aria-label="Close"
              >
                <FaTimes size={20} style={{color: '#262626'}} />
              </button>
            </div>
            ...
            <div className="flex gap-3 mt-6">
              <button
                onClick={() => setIsEditModalOpen(false)}
                className="flex-1 px-4 py-2 border rounded-md font-semibold transition-colors"
                style={{color: '#262626', borderColor: '#DBDBDB', backgroundColor: '#FFFFFF'}}
                onMouseEnter={(e) => {
                  e.currentTarget.style.backgroundColor = '#FAFAFA'
                }}
